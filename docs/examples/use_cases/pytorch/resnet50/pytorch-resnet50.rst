...
To train a model, run `docs <https://github.com/NVIDIA/DALI/tree/master/docs/examples/use_cases/pytorch/resnet50/main.py>` with the desired model architecture and the path to the ImageNet dataset:
