...
To train a model, run :fileref:`docs/examples/use_cases/pytorch/resnet50/main.py <docs/examples/use_cases/pytorch/resnet50/main.py>`_ with the desired model architecture and the path to the ImageNet dataset:
