...
To train a model, run :ref:`docs/examples/use_cases/pytorch/resnet50/main.py<main.py>` with the desired model architecture and the path to the ImageNet dataset:
